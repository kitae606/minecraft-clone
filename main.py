...
blocks = [
    ...
    load_texture('assets/dirt_block.png'), # 2
    load_texture('assets/stone.png'), # 3
    load_texture('assets/gold.png'),  # 4
    load_texture('assets/lava.png'),  # 5
    load_texture('assets/oak.png'),   # 6
    load_texture('assets/water.png'), # 7
    load_texture('assets/oak_grass.png'), # 8
    load_texture('assets/brick_block.png'), # 9
